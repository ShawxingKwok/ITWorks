...
性能、类型支持、和用法简易方便的程度，个人基于 {{< newTab DataStore "https://developer.android.com/topic/libraries/architecture/datastore?hl=zh-cn" >}}
做了一个新的方案 `KDataStore`。 
...
dependencies {
    ...
    implementation ("shawxingkwok:android-util-view:1.0.2")
    implementation ("io.github.shawxingkwok:kdatastore:1.0.0")
    implementation (project(":本地模型模块名称")) // 或远程仓库
}
```
