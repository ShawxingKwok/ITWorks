...
## Local fast storage framework contrast 
...
<tr>
    ...
    <td>
        ...
        <br><br>
        <span style="color:red">commit blocks for 1.4ms</span>
        <br> apply doesn't block，<span style="color:red">but you can't know if the writing succeeds.</span>
        <br><br><span style="color:red">Regardless of the writing result，it updates memory and notify listeners</span>
    </td>
    <td> 
        Read data to system-level memory first 
        <br><br><span style="color: green; ">Read and write smoothly</span>
        <br><br>write to disk asynchronously and periodically background
    </td>
    <td> Read and write to disk asynchronously. Update memory if the writing succeeds.
    <br><br>Observe via Flow, with each response taking 2.1 ms. </td>
    <td> 
        Based on DataStore
        <br><br> Read data to application-level memory first
        <br><br> <span style="color: green; ">Read and write smoothly</span>
        <br><br>Write to disk every time the memory updates, including the backup file. 
    </td>
</tr>

<tr>
    <td>Startup runtime(ms)</td>
    <td>2.2</td>
    <td>3.2</td>
    <td>49(async)</td>
    <td><span style="color: red; ">13</span>. The impact is minimal when the file size increases significantly.</td>
</tr>

<tr>
    <td>Reading IOException</td>
    <td>Return default</td>
    <td>Return default</td>
    <td rowspan="3"> Catch by yourself</td>
    <td><span style="color: green; ">Obtain from the backup file</span></td>
</tr>

<tr>
    <td>Writing IOException</td>
    <td>Replace with the backup file without this data.<br><br> `commit` returns `false`</td>
